 ...
 * 功能描述: 商户资金信息内容响应类
 *
 * @className:MerchantAccountContentResponse
 * @projectName:
 * @author: generater-code
 * @date: 2020-01-12 16:03:06
 */
@ApiModel(value = "商户资金信息内容响应参数", description = "商户资金信息内容响应参数")
public class MerchantAccountContentResponse extends BasePojo {
