 ...
 * 功能描述: 商户资金记录内容响应类
 *
 * @className:MerchantAccountRecordContentResponse
 * @projectName:
 * @author: generater-code
 * @date: 2020-01-12 16:03:06
 */
@ApiModel(value = "商户资金记录内容响应参数", description = "商户资金记录内容响应参数")
public class MerchantAccountRecordContentResponse extends BasePojo {
