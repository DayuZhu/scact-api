 ...
 * 功能描述: 商户资金记录列表请求类
 *
 * @className:MerchantAccountRecordListRequest
 * @projectName:
 * @author: generater-code
 * @date: 2020-01-12 16:03:06
 */
@ApiModel(value = "商户资金记录列表请求参数", description = "商户资金记录列表请求参数")
public class MerchantAccountRecordListRequest extends PageRequest {
